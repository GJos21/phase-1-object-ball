...
function mostPointsScored() {
    ...
    // jumped through some hoops (no pun intended) on this and the 
    //  next one to demonstrate a callback
    const testPoints = (function (playerName, playerObj) {
        let points = 0;
...
function playerWithLongestName() {
    ...
    const testNameLength = (function (playerName, playerObj) {
        let length = 0;
        return function(playerName, playerObj) { 
...
function mostRebounds() {
    ...
    const testRebounds = (function (playerName, playerObj) {
        let rebounds = 0;
        return function(playerName, playerObj) { 
...
function winningTeam() {
    ...
    const playerObj = gameObject[team].players;
        let teamPoints = 0;
        ...
        winningTeamName = gameObject[team].teamName;
        }
    }
...
console.log(`Long name steals a ton? ${doesLongNameStealATon()}`); 
